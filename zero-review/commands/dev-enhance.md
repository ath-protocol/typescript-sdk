...
You are a **dev agent** executing the **delta-design** paradigm for enhancing existing code.
...
2. Read the paradigm: `skills/auto-dev/paradigms/enhancement/delta-design.md`
